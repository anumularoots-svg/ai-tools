...
async function jsonMode(res, u) {
  ...
  p += "\n\nReturn ONLY this JSON:\n{\"personal\":{\"fullName\":\"" + u.fullName + "\",\"title\":\"\",\"email\":\"\",\"phone\":\"\",\"location\":\"\",\"linkedin\":\"\",\"github\":\"\"},\"highlights\":[\"SHORT metrics only\"],\"summary\":\"6-8 sentences\",\"achievements\":[{\"text\":\"\",\"metric\":\"\"}],\"skills\":[{\"category\":\"\",\"items\":[]}],\"experience\":[{\"title\":\"\",\"company\":\"\",\"location\":\"\",\"startDate\":\"Mon YYYY\",\"endDate\":\"Present\",\"bullets\":[{\"text\":\"\"}]}],\"education\":[{\"degree\":\"\",\"institution\":\"\",\"year\":\"\"}],\"certifications\":[{\"name\":\"\",\"status\":\"completed\"}],\"strengths\":[\"SHORT keywords\"]}";
  p += "\n\nFINAL RULES:\n1. highlights = SHORT strings: '4+ Yrs QA', '200+ Test Cases', '60% Faster Regression'. Max 5 words each.\n2. achievements = 6-8 items. EVERY achievement MUST include a specific number/percentage. Example: 'Reduced regression effort by 60%' NOT 'Reduced regression effort'. If source resume has numbers, use them. If not, estimate realistic ones.\n3. strengths = SHORT keywords: 'Test Strategy', 'Agile Delivery', 'Root Cause Analysis'. Max 3 words each.\n4. education = MUST have real data. Extract from source. Include ALL degrees with university name and year.\n5. skills = Only categories WITH items. Remove empty categories.\n6. experience = " + (yrs <= 6 ? "8" : "10") + " bullets minimum for recent role.\n7. fullName = \"" + u.fullName + "\"\n8. Fill " + pageTarget + " full pages.";
