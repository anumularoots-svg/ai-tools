...
async function jsonMode(res, u) {
  ...
  p += "\n\nReturn ONLY this JSON (generate ENOUGH content for " + pageTarget + " full pages):\n{\"personal\":{\"fullName\":\"" + u.fullName + "\",\"title\":\"\",\"email\":\"\",\"phone\":\"\",\"location\":\"\",\"linkedin\":\"\",\"github\":\"\"},\"highlights\":[\"6-8 short metric strings like: 13+ Years Experience, 15+ Enterprise Projects, Fortune 500 Clients, 99.9% Uptime SLA\"],\"summary\":\"6-8 line executive summary\",\"achievements\":[{\"text\":\"\",\"metric\":\"\"}],\"skills\":[{\"category\":\"Primary Technologies\",\"items\":[]},{\"category\":\"Cloud Platforms\",\"items\":[]},{\"category\":\"DevOps\",\"items\":[]}],\"experience\":[{\"title\":\"\",\"company\":\"\",\"location\":\"\",\"startDate\":\"Mon YYYY\",\"endDate\":\"Mon YYYY or Present\",\"bullets\":[{\"text\":\"STAR bullet with metric\"}]}],\"education\":[{\"degree\":\"\",\"institution\":\"\",\"year\":\"\"}],\"certifications\":[{\"name\":\"\",\"status\":\"completed\"}],\"strengths\":[\"6-8 professional competencies\"]}";
  p += "\n\nCRITICAL FINAL RULES:\n1. Include ALL education provided — never skip.\n2. Dates = \"Mon YYYY\". Current role endDate = \"Present\".\n3. Strengths = 6-8 competencies.\n4. Highlights = 6-8 metric cards.\n5. fullName = \"" + u.fullName + "\" — never change.\n6. Generate MINIMUM " + (yrs <= 2 ? "5" : yrs <= 6 ? "8" : "10") + " bullets for the most recent role.\n7. Skills must be grouped into 6+ categories with 3+ items each.\n8. Summary must be 6-8 sentences.\n9. Achievements must have 5+ items with specific numbers.\n10. Total content must FILL " + pageTarget + " page(s) — do NOT generate a half-empty resume.";
