 ...
 * Same-site history → goes back; direct/external landing → falls back to the homepage.
...
(function () {
  ...
  // Pages whose URL no longer matches what they are called. The slug is kept
  // for existing links and search traffic; the breadcrumb shows the real name.
  var LABELS = {
    "ai-cold-email": "Referral Email Writer",
    "h1b-sponsor-check": "H-1B Sponsor Check",
    "ats-checker": "ATS + JD Matcher"
  };
  ...
  function make() {
    ...
    back.onmouseover = function () { back.style.color = "#6C3CE1"; back.style.transform = "translateX(-2px)"; };
    ...
    var lbl = label();
    crumb.innerHTML =
      '<a href="/" style="color:#6C3CE1;text-decoration:none">Home</a>' +
